      <div class="sidebar">
        ...
        <p>2010 sees the redesign of our website. Take a look around and let us know what you think.<br /><a href="{{ url('/berita') }}">Read more</a></p>
        <h3>Useful Links</h3>
        <ul>
          <li><a href="{{ url('/berita') }}">link 1</a></li>
          <li><a href="{{ url('/berita') }}">link 2</a></li>
          <li><a href="{{ url('/berita') }}">link 3</a></li>
          <li><a href="{{ url('/berita') }}">link 4</a></li>
        </ul>
        <h3>Search</h3>
